...
def Disque():
    coul=0
    numerodecouleur = no_couleur.get()
    Xd = randrange(0,250)
    Yd = randrange(0,250)
    if numerodecouleur == 1:
        Canevas.create_oval(Xd,Yd,Xd + TAILLE,Yd + TAILLE,fill="red")
        label_3 = Label(frame_2,text = "Rouge",fg = 'blue', bg = "yellow",font = "Arial 15 italic")
        label_3.grid(row = 0,column = 1,padx = 10,pady = 5)
    else :
        Canevas.create_oval(Xd,Yd,Xd + TAILLE,Yd + TAILLE,fill="blue")
        label_3 = Label(frame_2,text = "Bleu",fg = 'blue', bg = "yellow",font = "Arial 15 italic")
        label_3.grid(row = 0,column = 1,padx = 10,pady = 5)
...
choix_2 = Radiobutton (frame_1,text = " Bleu ",variable = no_couleur,value = 2)
choix_2.grid(row = 1,column = 0,padx = 10,pady = 5)
...
bouton_disque = Button(fenetre,text = " Disque ",bg = 'pink',command = Disque)
...
bouton_disque.pack(side = RIGHT,padx = 10,pady = 10)
